...
public class GlobalShipVariables {
    ...
    public static float generatorHealth = 1.0f;
    public static float engine1Health = 0.0f;
    public static float engine2Health = 0.0f;
    public static float lifeSupportHealth = 1.0f;
